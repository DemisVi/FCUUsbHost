...
internal class Constants
{
    public struct RegexConstants
    {
        ...
        public const string DhcpLeaseListValues = @"(?<=[A-Z] )([\w\:\-\.]*) ?([\w\:\-\.]+)?(?<![A-Z ])";
    }
    public struct ToolConstants
    {
        public const string Udevadm = "udevadm";
        public const string DhcpLeaseList = "dhcp-lease-list";
        public const string DhcpLeaseListParsableQuery = "--parsable";
